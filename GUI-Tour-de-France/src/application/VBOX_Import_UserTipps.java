...
public class VBOX_Import_UserTipps {
	public static VBox vbox_Import_UserTipps() {
		...
		Label lb_header = new Label(
				"Wählen Sie die .CSV-Dateien aus, aus denen User und Tipps importiert werden sollen:");
		...
		vbox_BP_Import_UserTipps.getChildren().addAll(lb_header, vbox_chooseUserCSV, vbox_chooseTippsCSV,
				bt_executeImport);
