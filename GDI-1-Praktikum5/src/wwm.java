public class wwm 
{
	...
	public static void ausgeben (boolean richtig, int anzahl_richtige_antworten)
	{
		if (richtig)
		{
	...
	//Antwort auswerten	
	auswertung (antwort_spieler, richtige_antwort);
	//Ergebnis ausgeben
	
	//ausgeben (richtig, anzahl_richtige_antworten);
	/*
	###########
	# Frage 2 #
	###########
